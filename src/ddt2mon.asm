...
;	ENDIF
;	ENDIF
CSEG        ;; relocatable code ISIS-II ASM80 assembler --Ivo
;
...
;
START:
	LXI	SP,XSTACK-12	;INITIALIZE SP IN CASE OF ERROR
...
RINX:	DB	(BLOC-XSTACK) AND 0FFH	;LOCATION OF BC
	DB	(DLOC-XSTACK) AND 0FFH	;LOCATION OF DE
	DB	(HLOC-XSTACK) AND 0FFH	;LOCATION OF HL
	DB	(SLOC-XSTACK) AND 0FFH	;LOCATION OF SP
	DB	(PLOC-XSTACK) AND 0FFH	;LOCATION OF PC
...
MLOAD:	DS	2	;MAX LOAD ADDRESS
	DS	SSIZE	;STACK AREA
XSTACK:
PLOC	EQU	XSTACK-2	;PC IN TEMPLATE
HLOC	EQU	XSTACK-4	;HL
SLOC	EQU	XSTACK-6	;SP
ALOC	EQU	XSTACK-7	;A
FLOC	EQU	XSTACK-8	;FLAGS
BLOC	EQU	XSTACK-10	;BC
DLOC	EQU	XSTACK-12;D,E
;
